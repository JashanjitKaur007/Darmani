...
// import { User, Mail, Calendar, Edit2, Save, X, Eye, EyeOff, Loader } from "lucide-react";
...
//     // Simulate update (replace with real API call later)
//     setTimeout(() => {
//       const updatedUser = { 
//         ...user, 
...
//   if (!user) {
//     return <div className="p-8 text-center">Please log in to view your account.</div>;
//   }
...
//           <h2 className="text-3xl font-semibold text-gray-900">Account Information</h2>
          
//           {!isEditing && (
//             <button
//               onClick={() => setIsEditing(true)}
//               className="flex items-center gap-2 bg-violet-600 hover:bg-violet-700 text-white px-6 py-3 rounded-2xl transition"
//             >
//               <Edit2 size={18} />
//               Edit Profile
//             </button>
...
//             <div className="flex items-center gap-4 p-5 bg-zinc-50 rounded-2xl">
...
//                 className="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-violet-500"
//               />
//             </div>
...
//             <div>
//               <label className="block text-sm font-medium mb-1.5 text-gray-700">New Password (optional)</label>
...
//                 onClick={handleSave}
//                 disabled={loading}
//                 className="flex-1 bg-violet-600 text-white py-3.5 rounded-2xl font-medium flex items-center justify-center gap-2 hover:bg-violet-700 disabled:opacity-70"
//               >
